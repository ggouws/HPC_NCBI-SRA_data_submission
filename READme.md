...
8)  If you have an existing account, log in using the button on the top
...
9)  Once you are logged on (with or without the creation of a new
...
10)  On this page, there are expandable text boxes providing brief
...
11) When you are ready to begin your submission, click the “New
    Submission” button (in the middle near the top of the page).


12) Tabs at the top of the page will guide you through the submission
    process.


13) Under the first tab (“Submitter”), you will need to provide your
...
14) This will take you to the second tab (“General Info”), under which
...
15) Under the “Project Info” tab, you will need to:
...
16) Under the “BioSample” tab, various submission packages/tools will be
...
17) You will now need to provide your BioSample attributes/information.
...
19) At the next step (“7: Files”), you will need to submit your sequence
...
19.2) Through your web browser or an Aspera plug-in
...
19.3) Through a cloud-based system (Amazon Web Service or GoogleCloud)
...
20) When your submission is processed successfully, you should receive
    three emails:
...
21) If you need to make any changes to your submission, you can manage
